...
namespace JffCsharpTools.Domain.Interfaces.Repositories
{
    ...
    public interface IDefaultGuidRepository
    {
        ...
        Task<TEntity> Create<TEntity>(TEntity entity, bool saveChanges = false) where TEntity : DefaultGuidEntity, new();
        ...
        Task<IEnumerable<TEntity>> CreateBatch<TEntity>(IEnumerable<TEntity> entities, bool saveChanges = false) where TEntity : DefaultGuidEntity, new();
        ...
        Task<TEntity> GetByKey<TEntity, TKey>(TKey key, string[] include = null) where TEntity : DefaultGuidEntity, new();
        ...
        Task<TEntity> GetFirstOrDefault<TEntity>(Expression<Func<TEntity, bool>> filter, string[] include = null) where TEntity : DefaultGuidEntity, new();
        ...
        Task<IEnumerable<TEntity>> Get<TEntity>(Expression<Func<TEntity, bool>> filter, string[] include = null, bool asNoTracking = false) where TEntity : DefaultGuidEntity, new();
        ...
        /// <param name="asNoTracking">Whether to disable change tracking for performance</param>
        /// <returns>Collection of entities matching the filter criteria</returns>
        Task<IEnumerable<TEntity>> GetByFilter<TEntity, TFilter>(TFilter filter, string[] include = null, bool asNoTracking = false) where TEntity : DefaultGuidEntity, new() where TFilter : DefaultFilter<TEntity>, new();
        ...
        Task<IEnumerable<TEntity>> GetByUser<TEntity>(Guid userId, string[] include = null) where TEntity : DefaultGuidEntity, new();
        ...
        Task<PaginationResult<TEntity>> GetPaginated<TEntity>(PaginationResult<TEntity> pagination, Expression<Func<TEntity, bool>> filter, string[] includes = null, bool asNoTracking = false) where TEntity : DefaultGuidEntity, new();
        ...
        /// <param name="asNoTracking">Whether to disable change tracking for performance</param>
        /// <returns>Paginated result containing entities, total count, and pagination metadata</returns>
        Task<PaginationResult<TEntity>> GetPaginatedByFilter<TEntity, TFilter>(TFilter filter, string[] includes = null, bool asNoTracking = false) where TEntity : DefaultGuidEntity, new() where TFilter : DefaultFilter<TEntity>, new();
        ...
        /// <param name="asNoTracking">Whether to disable change tracking for performance</param>
        /// <returns>Paginated result containing entities, total count, and pagination metadata</returns>
        Task<PaginationResult<TEntity>> GetPaginatedByUser<TEntity>(PaginationResult<TEntity> pagination, Guid idUser, string[] includes = null, bool asNoTracking = false) where TEntity : DefaultGuidEntity, new();
        ...
        Task<bool> UpdateByKey<TEntity, TKey>(TEntity entity, TKey key, bool saveChanges = false) where TEntity : DefaultGuidEntity, new();
        ...
        Task UpdateBatch<TEntity>(IEnumerable<TEntity> entityList, bool forceDetach = false, bool saveChanges = false) where TEntity : DefaultGuidEntity, new();
        ...
        Task<bool> Delete<TEntity>(Expression<Func<TEntity, bool>> filter, bool saveChanges = false) where TEntity : DefaultGuidEntity, new();
        ...
        Task DeleteBatch<TEntity>(IEnumerable<TEntity> entityList, bool saveChanges = false) where TEntity : DefaultGuidEntity, new();
        ...
        /// <param name="saveChanges">Whether to immediately save changes to the database</param>
        /// <returns>True if the deletion was successful, false otherwise</returns>
        Task<bool> DeleteByKey<TEntity, TKey>(TKey key, bool saveChanges = false) where TEntity : DefaultGuidEntity, new();
