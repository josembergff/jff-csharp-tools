...
namespace JffCsharpTools.Domain.Entity
{
    ...
    public class DefaultGuidEntity<TEntity> where TEntity : DefaultGuidEntity<TEntity>, new()
    {
        /// <summary>
        ...
        protected Expression<Func<TEntity, bool>> GetDefaultFilter()
        {
            ...
            // Add CreatorUserId filter if CreatorUserId is not empty (valid user identifier)
