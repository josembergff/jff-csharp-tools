...
namespace JffCsharpTools.Domain.Entity
{
    ...
    public class DefaultEntity
    {
        ...
        protected Expression<Func<TEntity, bool>> GetDefaultFilter<TEntity>() where TEntity : DefaultEntity, new()
        {
        ...
        /// </summary>
        /// <returns>A LINQ expression for filtering entities of type TEntity</returns>
        public virtual Expression<Func<TEntity, bool>> GetFilter<TEntity>() where TEntity : DefaultEntity, new()
        {
