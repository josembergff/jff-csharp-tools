...
namespace JffCsharpTools.Application.Interfaces
{
    ...
    public interface IDefaultGuidService
    {
        ...
        Task<Result<int>> Create<TEntity>(Guid IdUser, TEntity entity, bool filterCurrentUser = true) where TEntity : DefaultGuidEntity, new();
        ...
        Task<Result<IEnumerable<TEntity>>> Get<TEntity>(TEntity entityFilter = null, string[] includes = null) where TEntity : DefaultGuidEntity, new();
        ...
        Task<Result<IEnumerable<TEntity>>> GetByUser<TEntity>(Guid IdUser, TEntity entityFilter = null, string[] includes = null) where TEntity : DefaultGuidEntity, new();
        ...
        Task<Result<IEnumerable<TEntity>>> GetByFilter<TEntity, TFilter>(TFilter filter, string[] includes = null) where TEntity : DefaultGuidEntity, new() where TFilter : DefaultFilter<TEntity>, new();
        ...
        Task<Result<TEntity>> GetByKey<TEntity, Tkey>(Guid IdUser, Tkey key, string[] includes = null, bool filterCurrentUser = true) where TEntity : DefaultGuidEntity, new();
        ...
        Task<Result<PaginationResult<TEntity>>> GetPaginated<TEntity>(PaginationResult<TEntity> pagination, Expression<Func<TEntity, bool>> filter, string[] includes = null, bool filterCurrentUser = true, Guid IdUser = default) where TEntity : DefaultGuidEntity, new();
        ...
        Task<Result<PaginationResult<TEntity>>> GetPaginatedByFilter<TEntity, TFilter>(TFilter filter, string[] includes = null) where TEntity : DefaultGuidEntity, new() where TFilter : DefaultFilter<TEntity>, new();
        ...
        Task<Result<PaginationResult<TEntity>>> GetPaginatedByUser<TEntity>(PaginationResult<TEntity> paginacao, Guid IdUser, string[] includes = null) where TEntity : DefaultGuidEntity, new();
        ...
        Task<Result<bool>> UpdateByKey<TEntity, TKey>(Guid IdUser, TEntity entity, TKey key, bool filterCurrentUser = true) where TEntity : DefaultGuidEntity, new();
        ...
        /// <returns>A response model containing a boolean indicating success or failure</returns>
        Task<Result<bool>> DeleteByKey<TEntity, TKey>(Guid IdUser, TKey key, bool filterCurrentUser = true) where TEntity : DefaultGuidEntity, new();
    }
